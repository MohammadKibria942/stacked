      ...
      {activeTab === "Burgers" && (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 w-full max-w-6xl">
          {burgerItems.map((item) => (
            <div key={item.name} className="bg-white dark:bg-neutral-900 rounded-lg shadow p-4 flex flex-col items-center">
              ...
              <button
                className="bg-primary text-primary-foreground px-4 py-2 rounded hover:bg-primary/90 transition flex items-center gap-2"
      ...
      {activeTab === "Chicken" && (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 w-full max-w-6xl">
          {chickenItems.map((item) => (
            <div
              key={item.name}
              className="bg-white dark:bg-neutral-900 rounded-lg shadow p-4 flex flex-col items-center"
            >
              <img
                src={item.image}
                alt={item.name}
